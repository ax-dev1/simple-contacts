...
(function($) {
	...
	/**
	 * Create a ContactsDaoHandler type
	 *
	 ...
	 */
	function ContactsDaoHandler(entityType,seed, opts) {
	...
	// --------- DAO Info Methods --------- //
	ContactsDaoHandler.prototype.entityType = function() {
	 ...
	 * @return the entity
	 */
	ContactsDaoHandler.prototype.get = function(id) {
	 ...
	 */
	ContactsDaoHandler.prototype.create = function(newEntity) {
		if (newEntity) {
	 ...
	 *
	 */
	ContactsDaoHandler.prototype["delete"] = function(id) {
		var entity = this._dataDic[id];
		if (entity) {
	 ...
	 */
	ContactsDaoHandler.prototype.deleteMany = function(ids){
		var that = this;
	...
	ContactsDaoHandler.prototype.batchDelete = function(match){
		var dao = this;
		var deletedIds = [];
	 ...
	 */
	ContactsDaoHandler.prototype.update = function(data) {
		var id = data[this._idName];
		if (typeof id === "undefined"){
			throw "BRITE ERROR: ContactsDaoHandler.update: data does not have an id property. Cannot update.";	
		}
		var entity = this._dataDic[id];
		if (entity) {
	 ...
	 * 
	 */
	ContactsDaoHandler.prototype.batchUpdate = function(data, match){
		var dao = this;
		var updatedList = [];
	 ...
	 */
	ContactsDaoHandler.prototype.list = function(opts) {
	 ...
	 */
	ContactsDaoHandler.prototype.count = function(match){
	...
	brite.ContactsDaoHandler = ContactsDaoHandler;
